...
hen you want to work on this project using R, double click on the .Rproj file, 
...
5. Store the new directory in the R_DAVIS_2022 folder you should have already created on your desktop.
