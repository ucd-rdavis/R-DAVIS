...
* Be able to subset a data frame
* Know the distinctions between base R and `tidyverse`
...
- [Accessing spreadsheets](https://video.ucdavis.edu/media/Week+3+Part+1%3A+Spreadsheet+Best+Practices/1_z9i2s55k/390286133)
- [Data Import](https://video.ucdavis.edu/media/Week+3%2C+Part+2%3A+Starting+with+Spreadsheets+in+R/1_e9mv3mvt/390286133)
- [Video Discussion](https://canvas.ucdavis.edu/courses/1098028/assignments/1714929)

## In Class Coding

[Submit Week 3 In Class Coding](https://canvas.ucdavis.edu/courses/1098028/assignments/1714936)
...
str(surveys)
## * class: data frame
## * how many rows: 35549,  how many columns: 13
...
## * how many species: 48 (well, 49, but the 49th value is "", i.e., blank)
```
</details>
</div>
<br>
...
surveys[-c(7:nrow(surveys)), ] # Equivalent to head(surveys)
```
