...
R-DAVIS only has 10 class sessions (and 10 labs), so missing class means that you are missing a sizable chunk of the course. We expect you to attend class in person, and will not have a hybrid remote option (in our experience, it works really poorly in this instructional context). Becuase we know that things do come up from time to time, we give each student one dropped in-class or lab submission (i.e., you can miss one). 
...
Videos will be posted by Monday. By Thursday at 10am before class, you are expected to post a brief discussion about the questions and major points of uncertainty you have after the video that you want to resolve in class. 9 weeks, 3 points each.

- Submitting weekly in-class scratch work.

These submissions are credit/no-credit (but we will pay attention to good faith effort). 9 weeks, 10 points each.

- Submitting take-home labs. 

These submissions are credit/no-credit, but again will be reviewed for good-faith effort (primarily, evidence of working and learning). 9 take-home labs, 10 points each.

- Midterm Exam: In-class exam, 45 points

We will provide guidance about the format later in the course. 
