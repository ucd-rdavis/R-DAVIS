---
title: 'Wk04: Manipulating and analyzing data in the tidyverse, Part 1'
---
...
- [Data manipulation Part 1a](https://video.ucdavis.edu/media/t/1_3i0lfxul/390286133)
- [Data manipulation Part 1b](https://video.ucdavis.edu/media/Week+4%3A+Data+Manipulation+Part+2+%28mutate%2C+group_by%2C+and+summarize%29/1_rgmwrirs/390286133)
- [Video Discussion](https://canvas.ucdavis.edu/courses/1098028/assignments/1714928)

## In Class Coding

[Submit Week 4 In Class Coding](https://canvas.ucdavis.edu/courses/1098028/assignments/1714937)
...
We'll read in our data using the `read_csv()` function, from the tidyverse package **`readr`**, instead of `read.csv()`, the base function for reading in data. The data we are going to be using today should already be in your R_DAVIS_2025 project in the folder `data`. 
...
We can also remove the missing values for weight before we attempt to calculate the summary statistics on weight. Because the missing values are removed first, we can omit `na.rm = TRUE` when computing the mean:
