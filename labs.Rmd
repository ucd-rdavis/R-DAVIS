...
Lab this week will be playing with the `surveys` data we worked on in class. Create a new script in your `scripts` folder called `lastname_week_3_lab.R` (with your own last name). 
