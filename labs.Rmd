...
3. Save your script as `lab_week_1.R` in an appropriate location
...
```{r, eval=FALSE}
# Part 1: Basic Arithmetic and Order of Operations
(15 + 7) * 3  # Result: 66 (parentheses force addition first)
sqrt(144)  # Result: 12
2^8  # Result: 256
...
# Part 5: Exploring Functions and Getting Help
?round  # Opens help for round function
round(3.14159, 2)  # Result: 3.14
abs(-15)  # Result: 15

# Part 6 involves adding comments and saving the script
```
</details>
...
First, open a new script in your workgin directory and save it to your `scripts` folder. Call this new script `week_2_lab`. 

Copy and paste the chunk of code below into your new `week_2_lab` script and run it. This chunk of code will create the vector you will use in your lab today. Check in your environment to see what it looks like. What do you think each line of code is doing? 
...
Lab this week will be playing with the `surveys` data we worked on in class. Create a new script in your `scripts` folder called `week_3_lab.R`. 
...
<details>
<summary>**DO NOT OPEN** until you are ready to see the answers for the the lab</summary>
```{r, eval=T}
#PROBLEM 1
...
<details>
<summary>**DO NOT OPEN** until you are ready to see the answers for the lab</summary>
```{r, eval = T}
library(tidyverse)
#1
...
<details>
<summary>**DO NOT OPEN** until you are ready to see the answers for Part A</summary>
```{r, eval = T}
...
<details>
<summary>**DO NOT OPEN** until you are ready to see the answers for Part B</summary>
```{r, eval=FALSE}
library(tidyverse)
