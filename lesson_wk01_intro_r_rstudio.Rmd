---
title: 'Wk01: Orientation to programming, R, and RStudio'
---
...
- [Why programming and Intro to R (part 1)](https://video.ucdavis.edu/media/Orientation+to+programming+R+and+RStudio/1_74skxlby/390286133)
- [Intro to R (part 2)](https://video.ucdavis.edu/media/Introduction+to+R/1_lc6zsh8j/390286133)

------ NO VIDEO DISCUSSION THIS WEEK ------
- [Video Discussion]()

## In Class Coding

[Submit Week 1 In Class Coding](https://canvas.ucdavis.edu/courses/1098028/assignments/1714934)

<br>

# Why programming?

Programming can make your work better than it already is.
...
<div class = "blue">
### Create a Project
Let's create a new project in RStudio for this class. All of your files for this class should live in this new project. 

1. Click the "File" menu button, then "New Project".
2. Click "New Directory".
3. Click "Empty Project".
4. Call your project "R_DAVIS_2025", and save it to your computer, somewhere that you will be able to find it later! For instance, you can save it within your Documents folder or on your Desktop. (If you have a Mac, you can use Finder to drag a folder to your "Favorites" so you can easily find it later.)
...
the bare bones of a new project. 
